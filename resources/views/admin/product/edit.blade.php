            ...
            <div class="card-body">
                <form method="POST" action="{{route('product.update',$product->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control rounded-pill @error('name') is-invalid @enderror" value="{{$product->name}}">
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <img class="img-fluid mb-2" src="{{asset($product->image)}}" width="100px" />
                    ...
                    <div class="form-group">
                        <label>Price</label>
                        <input type="number" name="price" class="form-control  rounded-pill @error('price') is-invalid @enderror" value="{{$product->price}}">
                        @error('price')
                        <span class="invalid feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
